...
export default function LeadModal() {
  ...
  return (
    <>
      ...
      <div
        className={`fixed top-0 right-0 h-full w-full max-w-2xl bg-white shadow-2xl z-[70] transition-transform duration-500 ease-in-out flex flex-col glass-panel border-l border-outline-variant ${
      ...
      >
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-surface-container-low border border-outline-variant/50 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-xs font-bold text-on-surface-variant block uppercase">
                          ...
                          <button
                            ...
                            className={`px-4 py-2 rounded-lg border text-xs font-semibold transition-all cursor-pointer ${
                              isChecked
                                ...
                                : "bg-white text-on-surface-variant border-outline-variant/60 hover:bg-surface-container-high"
                            }`}
                          >
                            {statusOption}
                          </button>
            ...
            <section>
              ...
              <div className="space-y-2">
                <textarea
                  ...
                  rows={4}
                  className="w-full bg-surface-container-low border border-outline-variant/50 rounded-lg px-4 py-2.5 text-sm focus:ring-2 focus:ring-primary/20 focus:border-primary outline-none transition-all resize-none"
                />
              </div>
            </section>
          </form>
        ...
        <div className="p-6 border-t border-outline-variant bg-surface-container-lowest flex items-center justify-end gap-3">
          <button
            type="button"
            onClick={handleClose}
            className="px-5 py-2.5 rounded-lg text-sm font-bold text-on-surface-variant hover:bg-surface-container transition-colors cursor-pointer"
          >
            Cancel
          </button>
          <button
            type="submit"
            form="lead-form"
            className="bg-primary hover:bg-primary-container text-on-primary hover:text-on-primary-container px-7 py-2.5 rounded-lg text-sm font-bold shadow-md shadow-primary/10 transition-all active:scale-95 cursor-pointer"
          >
